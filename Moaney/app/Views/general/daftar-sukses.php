    ...
    <section class="not-found mx-auto pt-145 pb-md-212 pb-100">
        <div class="container-fluid">
            <div class="text-center">
                    <img src="./assets/img/masuk-sukses.svg" alt="" class="rounded mx-auto d-block">
                    <defs>
            ...
            <div class="pt-70 pb-md-50 pb-150">
                <h2 class="text-4xl fw-bold text-center color-palette-1 mb-10">Yeay! Anda telah terdaftar</h2>
                <p class="text-lg text-center color-palette-1 m-0">Silahkan klik tombol di bawah ini<br
                        class="d-sm-block d-none">
                        untuk masuk</p>
            </div>
            <div class="button-group d-flex flex-column mx-auto">
                <a class="btn btn-homepage fw-medium text-lg text-white rounded-pill" href="../src/masuk.html"
                    role="button">Masuk</a>
            </div>
        </div>
    </section>
