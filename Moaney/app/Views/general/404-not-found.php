...
<section class="not-found mx-auto pt-145 pb-md-212 pb-100">
    <div class="container-fluid">
        <div class="text-center">
                <img src="./assets/img/404.svg" alt="" class="rounded mx-auto d-block">
                <defs>
        ...
        <div class="pt-70 pb-md-50 pb-150">
            <h2 class="text-4xl fw-bold text-center color-palette-1 mb-10">Oops! Tidak Ditemukan</h2>
            <p class="text-lg text-center color-palette-1 m-0">Halaman yang anda kunjungi belum<br
                    class="d-sm-block d-none">
                tersedia pada sistem kami</p>
        </div>
